...
public class GeminiChatCompletionService : IChatCompletionService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(exception, "Error de comunicación con Gemini API al generar respuesta de chat");
            throw new InvalidOperationException("No fue posible generar la respuesta con Gemini API.", exception);
        }
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            _logger.LogError(
                "Gemini API respondió con estado {StatusCode} al generar respuesta de chat",
                (int)response.StatusCode);

            throw new InvalidOperationException("No fue posible generar la respuesta con Gemini API.");
        }
        ...
        {
            throw new InvalidOperationException("Gemini API no devolvió una respuesta válida.");
        }
